    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder={'{\n  "name": "My Program",\n  "weeks": [ ... ]\n}'}
          rows={10}
          className="w-full rounded-xl border border-[#E5E5EA] dark:border-[#38383A] bg-white dark:bg-[#2C2C2E] p-4 text-sm font-mono text-[#1C1C1E] dark:text-white placeholder:text-[#8E8E93] focus:border-[#FF2D55] outline-none"
        />
      </div>

      <label className="block w-full bg-[#FF2D55] hover:bg-[#FF6482] text-white font-semibold py-3 rounded-xl transition-all active:scale-[0.98] cursor-pointer text-center text-sm">
        Or upload .json file
        <input
          ref={fileInputRef}
          type="file"
      ...
      {parsing && (
        <div className="text-center py-2">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#FF2D55] mx-auto mb-2" />
